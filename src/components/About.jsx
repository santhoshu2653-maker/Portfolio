...
// Tech stack SVG icons rendered in high-contrast dark badge containers
const JavaIcon = () => (
  <div className="flex flex-col items-center justify-center bg-black/85 backdrop-blur-md px-5 py-4 rounded-2xl border border-black/10 shadow-[0_10px_30px_rgba(0,0,0,0.2)] group hover:scale-105 transition-transform duration-300">
    <svg className="w-14 h-14 md:w-16 md:h-16" viewBox="0 0 128 128">
      ...
      <path fill="#5382A1" d="M83.528 71.122s5.58 5.784-6.154 10.372c-22.342 8.725-46.496.666-29.911-6.023 6.238-2.515 9.738-2.728 9.738-2.728s-3.397-2.4-11.715 2.103c-24.692 13.36 11.12 19.441 39.654 8.366 5.363-2.077 8.162-5.965 8.162-5.965-.001.001-9.774-6.125-9.774-6.125zM91.625 96.106c-.198.395-.461.781-.791 1.159 0 0 13.189-3.404 8.545-11.964-4.591-8.454-8.145-12.625 10.927-27.179 0 0-29.855 7.447-18.681 37.984z"/>
      {/* Java Orange Steam Plumes */}
      <path fill="#F89820" d="M76.203 0s11.752 11.752-11.146 29.835c-18.359 14.499-4.187 22.754-.005 32.198-10.7-9.662-18.555-18.159-13.29-26.074C59.003 24.494 80.823 18.793 76.203 0z"/>
      <path fill="#EA2D2E" d="M66.414 113.085c21.023 1.345 53.358-.745 54.156-10.672 0 0-1.473 3.777-17.441 6.776-18.02 3.384-40.215 2.988-53.367.819 0 .001 2.695 2.228 16.652 3.077z"/>
    </svg>
    <span className="text-xs font-bold text-white uppercase tracking-wider mt-1">Java</span>
  </div>
);
...
const ReactIcon = () => (
  <div className="flex flex-col items-center justify-center bg-black/85 backdrop-blur-md px-5 py-4 rounded-2xl border border-black/10 shadow-[0_10px_30px_rgba(0,0,0,0.2)] group hover:scale-105 transition-transform duration-300">
    ...
    <span className="text-xs font-bold text-white uppercase tracking-wider mt-1">React / Next.js</span>
  </div>
);
...
const SpringBootIcon = () => (
  <div className="flex flex-col items-center justify-center bg-black/85 backdrop-blur-md px-5 py-4 rounded-2xl border border-black/10 shadow-[0_10px_30px_rgba(0,0,0,0.2)] group hover:scale-105 transition-transform duration-300">
    ...
    <span className="text-xs font-bold text-white uppercase tracking-wider mt-1">Spring Boot</span>
  </div>
);

const About = () => {
  return (
    <section id="about" className="bg-[#89F336] pt-20 pb-40 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      <div className="max-w-6xl mx-auto flex flex-col md:flex-row gap-16 items-start">
        ...
        <div data-aos="fade-left" data-aos-delay="200" className="flex-1 text-black mt-8 md:mt-0 relative z-20">
          ...
          <p 
            className="text-lg font-bold mb-12 leading-relaxed max-w-3xl text-zinc-900"
            dangerouslySetInnerHTML={{ __html: aboutContent.bio }}
          />

          {/* Horizontal Skills Row */}
          <div className="flex flex-wrap items-center gap-6 mt-8">
            <div data-aos="zoom-in" data-aos-delay="300" className="drop-shadow-xl">
              <JavaIcon />
            </div>
            <div data-aos="zoom-in" data-aos-delay="450" className="drop-shadow-xl">
              <SpringBootIcon />
            </div>
            <div data-aos="zoom-in" data-aos-delay="600" className="drop-shadow-xl">
              <ReactIcon />
            </div>
          </div>
      ...
      {/* Torn paper divider at bottom transitioning into dark TechnicalSkills section */}
