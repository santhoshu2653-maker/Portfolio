...
const CreatorCard = ({ category, index }) => (
  <div 
    ...
    className="bg-white/5 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:scale-[1.02] hover:border-[#89F336]/30 hover:shadow-[0_20px_50px_rgba(137,243,54,0.15)] transition-all duration-500 group flex flex-col justify-between"
  >
    <div>
      <div className="flex justify-between items-start mb-6">
        <span className="text-4xl p-3 bg-white/5 rounded-2xl group-hover:bg-[#89F336]/10 group-hover:scale-110 transition-all duration-300">
          {category.icon}
        </span>
      ...
      <h3 className="text-white text-xl md:text-2xl font-black mb-3 tracking-tight group-hover:text-[#89F336] transition-colors">
        {category.title}
      </h3>
      ...
      <div className="max-w-6xl mx-auto relative z-10">
        ...
        >
          <a
            ...
            className="flex items-center gap-3 px-8 py-4 rounded-full bg-[#89F336] text-black font-bold text-lg hover:bg-[#89F336]/90 hover:shadow-[0_0_30px_rgba(137,243,54,0.4)] transition-all duration-500 group"
          >
            <svg
              className="w-6 h-6"
              fill="currentColor"
