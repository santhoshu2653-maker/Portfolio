...
const InternshipCard = ({ intern, index }) => (
  <div 
    ...
    className="bg-black/20 backdrop-blur-md border border-white/10 rounded-3xl p-8 hover:scale-[1.02] hover:bg-black/35 hover:border-[#89F336]/30 hover:shadow-[0_20px_50px_rgba(137,243,54,0.15)] transition-all duration-500 flex flex-col justify-between"
  >
    <div>
  ...
  <span className="bg-white/10 text-white text-[10px] font-black tracking-widest uppercase py-1 px-3 rounded-full border border-white/15">
    Internship
      ...
      <p className="text-[#89F336] text-sm font-black tracking-wide mb-6 uppercase">
        {intern.organization}
      </p>
      ...
      <div className="mb-6">
        ...
        <ul className="text-white/90 text-sm font-medium space-y-1 pl-4 list-disc marker:text-[#89F336]">
    ...
    <div className="pt-4 border-t border-white/10">
      ...
      <div className="flex flex-wrap gap-2">
        {intern.tech.map((t) => (
          <span 
            key={t}
            className="px-3 py-1 text-xs font-mono font-bold text-white bg-white/10 rounded-full border border-white/10 hover:bg-[#89F336]/10 hover:border-[#89F336]/30 hover:text-[#89F336] transition-all"
          >
            {t}
          </span>
        ))}
...
const Internships = () => {
  return (
    <section className="bg-[#89F336] pt-24 pb-32 px-6 md:px-12 w-full relative overflow-hidden font-sans">
      ...
      <div className="max-w-6xl mx-auto relative z-20">
        ...
        <div data-aos="fade-up" className="mb-16 md:mb-20 text-center">
          ...
          <p className="text-black/70 text-base md:text-lg font-semibold max-w-lg mx-auto">
