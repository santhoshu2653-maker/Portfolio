...
const ProjectCard = ({ project, aosDelay }) => (
  <div
    ...
    className={`relative rounded-2xl p-[1px] group transition-all duration-500 ${
      project.isFlagship
        ? 'bg-gradient-to-br from-[#89F336]/50 via-white/10 to-[#89F336]/30 hover:from-[#89F336] hover:via-[#89F336]/30 hover:to-[#89F336]/60'
  ...
  >
    ...
    >
      {/* Badge */}
      {project.badge && (
        <span className="inline-block text-xs font-bold tracking-widest uppercase text-[#89F336] bg-[#89F336]/10 px-3 py-1 rounded-full border border-[#89F336]/20 mb-4">
          {project.badge}
        </span>
      )}
      ...
      <div className="flex flex-wrap gap-2 mb-8">
        {project.techTags.map((tag) => (
          <span
            key={tag}
            className="px-3 py-1 text-xs font-bold text-white/70 bg-white/5 rounded-full border border-white/10 hover:bg-[#89F336]/20 hover:border-[#89F336]/30 hover:text-[#89F336] transition-all duration-300 cursor-default"
          >
            {tag}
          </span>
        ))}
      ...
      <div className="flex flex-wrap gap-3">
        ...
        {project.links.demo !== undefined && (
          <a
            ...
            className={`flex items-center gap-2 px-4 py-2 rounded-full text-sm font-semibold transition-all duration-300 ${
              project.links.demo
                ? 'bg-[#89F336] text-black hover:bg-[#89F336]/90 hover:shadow-[0_0_20px_rgba(137,243,54,0.4)]'
        ...
        {project.links.frontendDemo && (
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-2 px-4 py-2 rounded-full bg-[#89F336] text-black text-sm font-semibold hover:bg-[#89F336]/90 hover:shadow-[0_0_20px_rgba(137,243,54,0.4)] transition-all duration-300"
          >
            <ExternalLinkIcon />
            Frontend Demo
          </a>
      ...
      <div className="max-w-6xl mx-auto">
        ...
        >
          <a
            ...
            target="_blank"
            rel="noopener noreferrer"
            className="flex items-center gap-3 px-8 py-4 rounded-full border border-white/20 text-white font-bold text-lg hover:bg-[#89F336] hover:text-black hover:border-[#89F336] hover:shadow-[0_0_30px_rgba(137,243,54,0.3)] transition-all duration-500 group"
          >
            <GitHubIcon />
